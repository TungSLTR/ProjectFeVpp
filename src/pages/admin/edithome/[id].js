...
const EditHome = () => {
    ...
    const updateHome = async (e) => {
        ...
        try {
            ...
            await axios.patch(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/home/${id}`, formData, {
                headers: {
    ...
    const getHomeById = async () => {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/home/${id}`);
