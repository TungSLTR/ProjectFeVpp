...
const EditProduct = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.patch(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/adproducts/${id}`, formData, {
                headers: {
    ...
    const getProductById = async () => {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/adproducts/${id}`);
        ...
        console.log(response.data.tensp)
    ...
    const getMenus = async () => {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/admenus`);
