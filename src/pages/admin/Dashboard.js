...
const Dashboard = () => {
  ...
  const getReview = async () => {
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/review/dashboard`);
  ...
  const getHoadon = async () => {
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/counthoadon/hd`);
  ...
  const getHoadonToday = async () => {
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/counthoadontoday/hdtoday`);
  ...
  useEffect(() => {
    const fetchTotal = async () => {
      try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/pro/totalall`);
  ...
  useEffect(() => {
    const fetchTodayRevenue = async () => {
      try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/pro/totaltoday`);
        const revenue = response.data ?? 0;
  ...
  const handleReplySubmit = async () => {
    if (selectedReview) {
      ...
      try {
        await axios.patch(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/review/dashboard/${makh}/${masp}`, {
          reply: replyContent,
        });
        setReplyContent("");
