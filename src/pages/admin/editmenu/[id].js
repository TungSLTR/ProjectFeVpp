...
const EditMenu = () => {
    ...
    const updateMenu = async (e) => {
        ...
        try {
            ...
            await axios.patch(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/admenus/${id}`,
                {
                    name,
                    parent_id,
                    url,
    ...
    const getMenuById = async () => {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_REACT_APP_BACKEND_URL}admin/admenus/${id}`);
